...
def test_create_test_case_given_test_case_dto_updates_and_returns_dto(
        update_test_case_dto, create_test_cases):
    ...
    # Act
    storage_response = test_case_storage.update_test_case(
    ...
    assert storage_response == update_test_case_dto
